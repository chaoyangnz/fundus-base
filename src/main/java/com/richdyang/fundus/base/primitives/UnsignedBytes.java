...
import static com.richdyang.fundus.base.primitives.UnsignedBytes.LexicographicalComparator.INSTANCE;
...
public final class UnsignedBytes {
    ...
    public static byte checkedCast(long value) {
        isTrue(value >> 8 == 0, "out of range: %s", value);
        return (byte) value;
    }
     ...
     * it is consistent with {@link Arrays#equals(byte[], byte[])}.
     *
