...
import com.richdyang.fundus.base.Objects;
...
public final class Floats {
	 ...
	 * shorter array as the lesser. For example, {@code [] < [1.0f] < [1.0f,
	 * 2.0f] < [2.0f]}.
	 * 
	 * <p>
...
//			checkElementIndex(index, size());
		...
		public int hashCode() {
			int result = 1;
			for (int i = start; i < end; i++) {
				result = 31 * result + Objects.HashCodeHelper.hashCode(array[i]);
			}
			return result;
		}
