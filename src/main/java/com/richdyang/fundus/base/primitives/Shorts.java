...
public final class Shorts {
	 ...
	 * 
	 * @param value
	 *            any value in the range of the {@code short} type
	 * @return the {@code short} value that equals {@code value}
	 * @throws IllegalArgumentException
	 *             if {@code value} is greater than {@link Short#MAX_VALUE} or
	 *             less than {@link Short#MIN_VALUE}
	 */
	public static short checkedCast(long value) {
		short result = (short) value;
		ArgumentAssert.isTrue(result == value, "Out of range: %s", value);
		return result;
	}
	 ...
	 * For example, {@code concat(new short[] a, b}, new short[] {}, new short[]
	 * {c}} returns the array {@code a, b, c} .
	 * 
	 * @param arrays
	 *            zero or more {@code short} arrays
	 ...
	 * in the first ? bytes of {@code bytes}; equivalent to {@code
	 ...
	 * 
	 * @throws IllegalArgumentException
	 *             if {@code bytes} has fewer than ? elements
	 */
	public static short fromByteArray(byte[] bytes) {
		ArgumentAssert.isTrue(bytes.length >= BYTES, "array too small: %s < %s",
				bytes.length, BYTES);
	 ...
	 * 
	 * @param collection
	 *            a collection of {@code Short} objects
	...
	private static class ShortArrayAsList extends AbstractList<Short> implements
...
//			checkElementIndex(index, size());
		...
		/* @Override */public List<Short> subList(int fromIndex, int toIndex) {
			...
			return new ShortArrayAsList(array, start + fromIndex, start
					+ toIndex);
		}
