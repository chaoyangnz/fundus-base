...
import static com.richdyang.fundus.base.text.Splitter.AbstractIterator.State.*;
...
public final class Splitter {
            ...
            public SplittingIterator iterator(Splitter splitter,
                ...
                return new SplittingIterator(splitter, toSplit) {
                    ...
                    public int separatorStart(int start) {
                        ...
                        positions:
                        for (int p = start, last = toSplit.length()
    ...
    public static Splitter on(final Pattern separatorPattern) {
        notNull(separatorPattern);
        isTrue(!separatorPattern.matcher("").matches(),
     ...
     *                         separator. This pattern may not match the empty string.
     * @return a splitter, with default settings, that uses this pattern
     * @throws PatternSyntaxException if {@code separatorPattern} is a malformed expression
     * @throws IllegalArgumentException               if {@code separatorPattern} matches the empty string
     */
    public static Splitter onPattern(String separatorPattern) {
        return on(compile(separatorPattern));
    }
    ...
    public static Splitter fixedLength(final int length) {
        isTrue(length > 0, "The length may not be less than 1");
    ...
    private static abstract class AbstractIterator<T> implements Iterator<T> {
        ...
        public final boolean hasNext() {
            ArgumentAssert.state(state != FAILED);
            switch (state) {
                case DONE:
                    return false;
                case READY:
