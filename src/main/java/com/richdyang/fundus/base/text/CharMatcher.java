...
public abstract class CharMatcher implements Matcher<Character> {
    ...
    public static final CharMatcher ANY = new CharMatcher() {
        ...
        public String collapseFrom(CharSequence sequence, char replacement) {
            return (sequence.length() == 0) ? "" : valueOf(replacement);
        }
    ...
    public static CharMatcher anyOf(final CharSequence sequence) {
        ...
        sort(chars); // not worth collapsing duplicates

        return new CharMatcher() {
            @Override
            public boolean matches(Character c) {
                return binarySearch(chars, c) >= 0;
            }
    ...
    public static CharMatcher forPredicate(
        ...
        return new CharMatcher() {
            ...
            public boolean matches(Character character) {
                return matcher.matches(notNull(character));
            }
        };
    }
     ...
     */
    public CharMatcher and(CharMatcher other) {
        return new And(asList(this, notNull(other)));
    }
    ...
    private static class And extends CharMatcher {
        ...
        public CharMatcher and(CharMatcher other) {
            List<CharMatcher> newComponents = new ArrayList<CharMatcher>(
                    components);
            newComponents.add(notNull(other));
     ...
     */
    public CharMatcher or(CharMatcher other) {
        return new Or(asList(this, notNull(other)));
    }
     ...
     * @param start    the first index to examine; must be nonnegative and no greater
     ...
     * <pre>
     *
     * @code CharMatcher.is('a').removeFrom("bazaar")}
     * </pre>
     * <p>
     * ... returns {@code "bzr"}.
     */
     ...
     * <pre>
     *
     * @code CharMatcher.is('a').retainFrom("bazaar")}
     * </pre>
     * <p>
     * ... returns {@code "aaa"}.
     */
     ...
     * @code CharMatcher.is('a').replaceFrom("radar", 'o')}
     * </pre>
     * <p>
     * ... returns {@code "rodor"}.
     * <p>
     ...
     *                    matching character in {@code sequence}
     * @return the new string
     * @code CharMatcher.is('a').replaceFrom("yaha", "oo")}
     * </pre>
     * <p>
     * ... returns {@code "yoohoo"}.
     * <p>
     ...
     * <pre>
     *
     * @code CharMatcher.anyOf("ab").trimFrom("abacatbab")}
     * </pre>
     * <p>
     * ... returns {@code "cat"}.
     * <p>
     ...
     * <p>
     * <pre>
     * @code CharMatcher.inRange('\0', ' ').trimFrom(str)}
     * </pre>
     * <p>
     ...
     * <pre>
     *
     * @code CharMatcher.anyOf("ab").trimLeadingFrom("abacatbab")}
     * </pre>
     * <p>
     * ... returns {@code "catbab"}.
     */
     ...
     * <pre>
     *
     * @code CharMatcher.anyOf("ab").trimTrailingFrom("abacatbab")}
     * </pre>
     * <p>
     * ... returns {@code "abacat"}.
     */
     ...
     * @return the new string
     * @code CharMatcher.anyOf("eko").collapseFrom("bookkeeper", '-')}
     * </pre>
     * <p>
     * ... returns {@code "b-p-r"}.
     * <p>
