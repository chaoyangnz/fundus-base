...
import static org.inframesh.fundus.base.ArgumentAssert.indexInBounds;
...
import org.inframesh.fundus.base.Objects.HashCodeHelper;
...
public final class Booleans {
	 ...
	 * replacing {@code Booleans.contains(array, true)} with {@code
	 * !bitSet.isEmpty()} and {@code Booleans.contains(array, false)} with
	 * {@code bitSet.nextClearBit(0) == sizeOfBitSet}.
	 * 
	 * @param array
	 *            an array of {@code boolean} values, possibly empty
	 * @param target
	 ...
	 * <p>
	 * <b>Note:</b> consider representing the array as a {@link BitSet} instead,
	 * and using {@link BitSet#nextSetBit(int)} or
	 * {@link BitSet#nextClearBit(int)}.
	 * 
	 * @param array
	 *            an array of {@code boolean} values, possibly empty
	 * @param target
	 ...
	 * 
	 * @param arrays
	 *            zero or more {@code boolean} arrays
	 ...
	 * {@link #compare(boolean, boolean)}), the first pair of values that follow
	 * any common prefix, or when one array is a prefix of the other, treats the
	 * shorter array as the lesser. For example, {@code [] < [false] < [false,
	 * true] < [true]}.
	 * 
	 * <p>
	 ...
	 * 
	 * @param collection
	 *            a collection of {@code Boolean} objects
...
//			checkElementIndex(index, size());
		...
		public int lastIndexOf(Object target) {
			// Overridden to prevent a ton of boxing
			if (target instanceof Boolean) {
				int i = Booleans.lastIndexOf(array, (Boolean) target, start,
						end);
				if (i >= 0) {
					return i - start;
				}
...
//			checkElementIndex(index, size());
		...
		/* @Override */public List<Boolean> subList(int fromIndex, int toIndex) {
			...
			return new BooleanArrayAsList(array, start + fromIndex, start
					+ toIndex);
		}
	...
	public static Boolean[] toWrapperArray(boolean[] array) {
		if(array == null) {
			return null;
		}
